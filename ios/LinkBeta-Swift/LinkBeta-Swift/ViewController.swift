...
class ViewController: UIViewController {
    ...
    override func awakeFromNib() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ViewController.didReceiveNotification(_:)), name: NSNotification.Name(rawValue: "PLBPlaidLinkSetupFinished"), object: nil)
    }
    ...
    func didReceiveNotification(_ notification: NSNotification) {
        if notification.name.rawValue == "PLBPlaidLinkSetupFinished" {
